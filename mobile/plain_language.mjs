...
Use concrete everyday language, not compressed theory. "Readiness" can mean "having it ready to use"; "a cue" can mean "what made you reach for the phone"; "a gap in readiness" can mean "one thing was easier to start than the other". Describe the actual situation instead of repeating these abstract labels. Do not use "focused explanation", "working hypothesis", "affordance" or "low-burden" when ordinary words carry the meaning.
Rewrite the reasons and stop/change signals just as carefully as the action. Examples of complete rewrites: "this learning path is not discriminating enough" becomes "this check did not help you tell the possible causes apart"; "before any non-refundable cost is incurred" becomes "before you spend money you cannot get back"; "the current restriction is weaker or different" becomes "the rule may not apply, or may be different". Do not leave those abstract originals in an otherwise simple answer. In titles, use concrete words such as "reminder" or "starting point" instead of "cue" or "trigger" when that is what the source means. These examples show wording only; do not add their facts to unrelated options.
Aim for a title of three to seven everyday words, an action under 40 words, a reason under 20 words, and a stop/change signal under 30 words. These are soft targets: preserve essential details even when more words are necessary. Avoid repeating the same explanation across fields. Never remove a condition or warning to fit a target. The title should name what to do, not a theory about it. Read the answer back as everyday speech before returning it.
